// Dashboard do Administrador (feature-level)
...
import QuickActionCard from '@/components/admin/components/QuickActionCard';
      ...
      <section className="mt-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4">
          <QuickActionCard
            ...
            subtitle="Evento"
            icon={Plus}
            bgClassName="bg-[#4C1D95]/10 group-hover:bg-[#4C1D95]/20"
          ...
          <QuickActionCard
            ...
            subtitle="Jogo"
            icon={Calendar}
            bgClassName="bg-[#EF4444]/10 group-hover:bg-[#EF4444]/20"
          ...
          <QuickActionCard
            ...
            subtitle="Jogador"
            icon={UserPlus}
            bgClassName="bg-[#22C55E]/10 group-hover:bg-[#22C55E]/20"
